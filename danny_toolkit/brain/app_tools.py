...
APP_TOOLS: Dict[str, AppDefinition] = {
    ...
    "nlp_studio": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.nlp_studio",
    ...
    "ml_studio": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.ml_studio",
    ...
    "vector_studio": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.vector_studio",
    ...
    "advanced_questions": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.advanced_questions",
    ...
    "knowledge_companion": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.knowledge_companion",
    ...
    "legendary_companion": AppDefinition(
        ...
        categorie=AppCategorie.AI,
        module_path="danny_toolkit.ai.legendary_companion",
