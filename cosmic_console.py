"""
COSMIC CONSOLE — Nexus Terminal v6.0
=====================================
...
Gebruik: python cosmic_console.py
"""
...
def show_boot_log(boot_log: str) -> None:
...
def render_payload(p: object, elapsed: float = 0.0) -> None:
    """Render een SwarmPayload naar de console.

    Args:
        p: SwarmPayload object.
        elapsed: Totale executietijd in seconden.
    """
