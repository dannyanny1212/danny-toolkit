...
QUEST_CHECKS = [
    (
        "I - THE CORE",
        "danny_toolkit.quests.core_protocol",
        ["CoreProtocol"],
    ),
    (
        "II - THE DAEMON",
        "danny_toolkit.quests.daemon_protocol",
        ["DaemonProtocol"],
    ),
    (
        "III - THE MIND",
        "danny_toolkit.quests.mind_protocol",
        ["MindProtocol"],
    ),
    (
        "IV - THE SENSES",
        "danny_toolkit.quests.senses_protocol",
        ["SensesProtocol"],
    ),
    (
        "V - THE BODY",
        "danny_toolkit.quests.body_protocol",
        ["BodyProtocol"],
    ),
    (
        "VI - THE BRAIN",
        "danny_toolkit.quests.brain_protocol",
        ["BrainProtocol"],
    ),
    (
        "VII - THE TRINITY",
        "danny_toolkit.quests.trinity_protocol",
        ["TrinityProtocol"],
    ),
    (
        "VIII - THE BRIDGE",
        "danny_toolkit.quests.bridge_protocol",
        ["BridgeProtocol"],
    ),
    (
        "IX - THE PULSE",
